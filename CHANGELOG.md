...
### Released
- Published **agent-eval-arena** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **agent-eval-arena**.
...
- That insight became the basis for **agent-eval-arena**.
